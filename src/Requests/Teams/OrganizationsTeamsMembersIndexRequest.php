...
/**
 * organizations.teams.members.index
 *
 * Show all members for the team.
 *
 * Processing mode: <small><code>sync</code></small>
 */
class OrganizationsTeamsMembersIndexRequest extends Request implements Paginatable
{
    use CanBeSent;
    ...
    {
        return "/orgs/{$this->organization}/teams/{$this->team}/members";
    }
}
